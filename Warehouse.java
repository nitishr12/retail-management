...
public class Warehouse extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            PreparedStatement pst = conn.prepareStatement("select w.name,w.address_line_1,w.address_line_2,w.city,w.warehouse_id from retail1.warehouse w inner join retail1.warehouse_manager w1 on w.warehouse_id=w1.warehouse_id inner join retail1.user u on w1.uid=u.uid where u.uid=?");
