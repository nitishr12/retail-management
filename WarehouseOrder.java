...
public class WarehouseOrder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            PreparedStatement pst = conn.prepareStatement("select s.order_id,s1.quantity_ordered,s.delivery_date,s.status from retail1.store_order s inner join retail1.store_order_item s1 on s.order_id=s1.order_id where s.warehouse_id=?");
